...
//   const parentIdSafe: string | null = values.parentId ?? null;

//   const parentName = findMemberNameById(parentIdSafe, existingMembers);
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="file" placeholder="Image URL" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
